...
export function JapaneseBrandingExperience() {
  ...
  useEffect(() => {
    ...
    if (dropdownOpen || servicesMenuOpen) {
          ...
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            {servicesMenuOpen && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-72 max-h-[75vh] overflow-y-auto bg-[#0A0A0A] border border-white/20 rounded-2xl shadow-2xl p-2 z-50 flex flex-col gap-1">
                ...
                {[
                  { id: "01", name: "Website Development", href: "/services/web-development", tag: "CODE" },
                  ...
                  { id: "06", name: "Branding & Design", href: "/services/branding-design", tag: "CURRENT", note: "✦ Unifiers UI" },
                  ...
                  >
                    ...
                    {s.note ? (
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-black text-white font-bold shrink-0">
                        {s.note}
                      </span>
                    ) : (
