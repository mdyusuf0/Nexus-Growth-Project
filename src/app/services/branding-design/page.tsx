...
export const metadata: Metadata = {
  title: 'Unifiers of Japan & Brand // APERTURE STUDIOS Flagship Showcase',
  ...
  keywords: ['Unifiers of Japan', 'editorial branding', 'Japanese design agency', 'brand identity', 'Sengoku period', 'Oda Nobunaga', 'APERTURE STUDIOS'],
};
